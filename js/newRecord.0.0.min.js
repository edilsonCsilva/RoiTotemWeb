var bodyDocumentHeight=document.body.clientHeight,localStorger=new LocalStorger,token=localStorger.getToObject("token"),campaign=localStorger.getToObject("campaign"),modal=$("#msn"),boxProcess=$("#box-process"),containerTerms="",waitingTime=new Date,timesClicksPagers=80,timesContexSetInteval=null,limitTime=100;function getBoxProcess(e,o){o?e.html(' <div   class="box-process" ><div class="box-process item">Buscando Endereço...</div> </div>'):e.html("")}function openTerms(e){var o=bodyDocumentHeight-250;try{var t=(t=`<div class="modal" tabindex="-1" id="terms">
                            ...
                            <div class="modal-content">
                                ...
                                <button type="button" class="btn-close onClickClose"   data-bs-dismiss="modal" aria-label="Close"></button>
                                 ...
                                 <div class="modal-body">
                                  <div id="divContent" class=' ' style="height:`+o+`px; overflow:auto; ">
                                  :conteudo
                                  </div>
                                </div>
